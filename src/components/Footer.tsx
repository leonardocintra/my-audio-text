      ...
      <div className="container mx-auto px-4 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          <div className="space-y-4">
            <Link
              href="/"
              className="flex items-center gap-2 font-headline font-bold text-xl text-primary-foreground"
            >
            ...
            <div className="flex space-x-4">
              <Link
                href="https://github.com/leonardocintra/my-audio-text"
                className="text-muted-foreground hover:text-primary-foreground transition-colors"
              >
                <Github />
              </Link>
              <Link
                href="https://x.com/leonardoncintra"
                className="text-muted-foreground hover:text-primary-foreground transition-colors"
              >
                <Twitter />
              </Link>
              <Link
                href="https://www.linkedin.com/in/leonardo-nascimento-cintra/"
                className="text-muted-foreground hover:text-primary-foreground transition-colors"
              >
                <Linkedin />
              </Link>
          ...
          <div>
            <h3 className="font-semibold text-primary-foreground tracking-wider uppercase font-headline">
              {t("links.title")}
            </h3>
